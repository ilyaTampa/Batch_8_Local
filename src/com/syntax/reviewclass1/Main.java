...
public class Main {
    ...
    public static void main(String[] args) {
		...
		//Numeric data types
		/*
		we have 6 Numeric data types byte  short int long
		float double
		 */
		float floatNumber=102.015245651158224155852255f;
        System.out.println(floatNumber);

        double doubleNumber=102.015245651158224155852255f;
        ...
        double pi=3.15486489652458632899;
